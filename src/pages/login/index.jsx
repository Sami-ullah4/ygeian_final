...
import { googleLogin, login } from "../../features/auth/auth.action";
...
const LoginPage = () => {
  ...
  //     dispatch(googleLogin(tokenResponse.accessToken));
  //   },
        ...
        <div className="flex flex-col lg:flex-col bg-white items-center justify-center gap-3 lg:gap-6">
          <div className="flex flex-col gap-3 w-full px-4 lg:max-w-[640px]">
            <div className="flex flex-col lg:flex-row justify-center items-center gap-5">
              <button
                className="lg:w-[215px] w-full border border-[#D6E0E4] p-3 rounded-full flex justify-center items-center gap-2 hover:bg-gray-50 transition-colors"
              ...
              <button className="lg:w-[215px] w-full border border-[#D6E0E4] p-3 rounded-full flex justify-center items-center gap-2 hover:bg-gray-50 transition-colors">
                <img
                  src={link}
                  alt="LinkedIn icon"
                  className="w-[24px] h-[24px]"
